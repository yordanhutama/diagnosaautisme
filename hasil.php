...
<html lang="en">
    <?php
        ...
        if (isset($_POST['g1']) + isset($_POST['g2']) + isset($_POST['g3']) + isset($_POST['g4']) == 4) {
            $hasil = 1;
        }
        ?>
    <head>
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="intro-text">
                            <h1>Hasil Menunnjukkan</h1>
                            <?php
                        if ($hasil == 1 && $terapi ==1) {
                            echo '<p>Anak anda genius</p><br>';
                        }
                        if ($terapi ==0) {
                            echo '<p>goblok lo</p><br>';
                        }
                        
                        ?>
                        <a href="soal.html" class="btn btn-default btn-lg page-scroll">Diagnosa Ulang</a> </div>
                    </div>
                </div>
            </div>
        </header>
        <div id="footer">
            <div class="container text-center">
                <div class="fnav">
                    <p>Copyright &copy; 2018 Pendidikan Informatika. Designed by Naufal & Nida</p>
                </div>
            </div>
        </div>
    </body>
